...
export const ExportModal: React.FC<ExportModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 bg-black/85 backdrop-blur-md animate-in fade-in duration-200">
      <div
        className="bg-slate-900 border border-amber-800/80 rounded-2xl w-full max-w-4xl max-h-[92vh] overflow-hidden shadow-2xl shadow-amber-950/60 flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        
        {/* Header */}
        <div className="p-4 sm:p-5 border-b border-amber-950 bg-[#070e1a] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-amber-950 border border-amber-700/60 flex items-center justify-center text-amber-500">
              <Github className="w-5 h-5" />
            </div>
            <div>
              <h2 className="text-base sm:text-lg font-bold text-white flex items-center gap-2">
                Arquivos do PWA para GitHub Pages
                <span className="text-[11px] font-mono font-semibold px-2 py-0.5 rounded bg-amber-950 border border-amber-800 text-amber-300">
                  Pronto para Deploy
                </span>
              </h2>
        ...
        <div className="flex items-center justify-between px-5 pt-3 border-b border-amber-950 bg-[#08111e]">
          ...
          <a
            ...
            className="text-xs font-semibold text-amber-500 hover:text-amber-300 flex items-center gap-1 px-2.5 py-1 rounded bg-amber-950/60 border border-amber-800/60 transition mb-2"
          >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 custom-scrollbar">
          ...
          {activeTab === 'code' ? (
            <div className="space-y-4">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-mono font-bold transition whitespace-nowrap flex items-center gap-1.5 border ${
                      selectedFile === key
                        ...
                        : 'bg-slate-900/80 text-slate-300 border-amber-950 hover:border-slate-700'
                    }`}
                  >
              ...
              {/* File Action Bar */}
              <div className="p-3 bg-[#060e1b] rounded-xl border border-amber-950 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold border transition ${
                      copied
                        ...
                        : 'bg-amber-950/90 text-amber-300 border-amber-700/80 hover:bg-amber-900'
                    }`}
                  >
              ...
              <div className="relative">
                <pre className="p-4 rounded-xl bg-[#030711] border border-amber-950 font-mono text-xs text-slate-300 overflow-x-auto max-h-[480px] custom-scrollbar select-text leading-relaxed">
            ...
            <div className="space-y-5 text-slate-300 text-xs sm:text-sm leading-relaxed">
              ...
              <div className="p-4 rounded-xl bg-amber-950/30 border border-amber-800/60">
                ...
                <p className="text-slate-300 text-xs">
                  O projeto foi arquitetado 100% estático e com caminhos relativos (<code className="text-amber-300 font-mono">./</code>), não necessitando de Node.js, Webpack ou build servers no GitHub Pages.
                </p>
              </div>
              ...
              <div className="grid gap-4">
                ...
                {/* Passo 1 */}
                <div className="p-4 rounded-xl bg-[#07111e] border border-amber-950 flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-amber-950 border border-amber-800 text-amber-500 flex items-center justify-center font-mono font-bold text-xs flex-shrink-0 mt-0.5">
                    1
                  </span>
                  <div>
                    ...
                    <p className="text-slate-400 text-xs">
                      Acesse <a href="https://github.com/new" target="_blank" rel="noreferrer" className="text-amber-500 underline">github.com/new</a>, defina o nome (ex: <code className="text-slate-200">curso-comunicacao-assertiva</code>) e marque como <strong>Público</strong>.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#07111e] border border-amber-950 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="bg-black p-2.5 rounded font-mono text-[11px] text-amber-300 border border-amber-950 space-y-0.5">
                      <div>├── index.html</div>
                      <div>├── styles.css</div>
                      <div>├── app.js</div>
                ...
                <div className="p-4 rounded-xl bg-[#07111e] border border-amber-950 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <ol className="list-decimal list-inside text-xs text-slate-300 space-y-1">
                      ...
                      <li>Em <strong>Branch</strong>, selecione <code className="text-amber-300 font-mono">main</code> e a pasta <code className="text-amber-300 font-mono">/ (root)</code>.</li>
                ...
                <div className="p-4 rounded-xl bg-[#07111e] border border-amber-950 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-xs">
                      ...
                      <br />
                      <code className="text-amber-300 font-mono bg-black/50 px-2 py-0.5 rounded mt-1 inline-block">
        ...
        {/* Footer */}
        <div className="p-4 border-t border-amber-950 bg-[#070e1a] flex items-center justify-between">
