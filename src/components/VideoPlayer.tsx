...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  return (
    <div className="bg-[#0b1626] border border-amber-950/80 rounded-2xl overflow-hidden shadow-2xl shadow-black/50">
      ...
      <div className="relative aspect-video w-full bg-[#02060d] overflow-hidden group">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center z-10">
          ...
          <button
            ...
            className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-tr from-amber-600/30 to-amber-500/20 border-2 border-amber-500/60 flex items-center justify-center text-amber-300 shadow-[0_0_30px_rgba(56,189,248,0.35)] hover:scale-105 active:scale-95 transition-all duration-300 mb-4 group/btn"
          >
            {isPlaying ? (
              <Pause className="w-7 h-7 text-amber-300 fill-amber-300" />
            ) : (
              <Play className="w-7 h-7 text-amber-300 fill-amber-300 ml-1 group-hover/btn:translate-x-0.5 transition-transform" />
            )}
          </button>

          <span className="text-xs font-mono uppercase tracking-widest text-amber-500/90 mb-1">
          ...
          <div className="mt-4 px-3 py-1 bg-black/60 backdrop-blur-md rounded-md border border-amber-900/60 text-[11px] font-mono text-amber-300/80">
        ...
        <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/90 to-transparent p-3 flex items-center justify-between text-xs text-slate-300 z-20">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={cycleSpeed}
              className="px-2 py-0.5 rounded bg-slate-800/80 hover:bg-slate-700 text-[11px] font-mono font-bold text-amber-500 border border-slate-700 transition"
      ...
      <div className="p-5 sm:p-6 border-b border-amber-950/60 bg-[#081220]/70 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="text-[11px] font-bold uppercase tracking-wider text-amber-500 bg-amber-950/60 border border-amber-800/50 px-2 py-0.5 rounded">
        ...
        <div className="flex items-center flex-wrap gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs sm:text-sm font-bold text-white bg-gradient-to-r from-amber-500 via-blue-600 to-indigo-600 hover:from-amber-400 hover:to-blue-500 border border-amber-500/40 shadow-lg shadow-amber-500/25 active:scale-95 transition"
          >
      ...
      <div className="p-5 sm:p-6 space-y-5">
        ...
        {/* Framework Box */}
        <div className="p-4 rounded-xl bg-gradient-to-r from-amber-950/40 via-amber-950/30 to-amber-950/20 border-l-4 border-amber-500 border-y border-r border-amber-900/40">
        ...
        <div>
          ...
          <ul className="grid gap-2.5">
            {(lesson.keyPoints || lesson.summary).map((point: string, i: number) => (
              <li
                key={i}
                className="flex items-start gap-2.5 text-xs sm:text-sm text-slate-300 bg-[#07111e] p-3 rounded-lg border border-amber-950/70"
              >
                <span className="w-5 h-5 rounded-full bg-amber-950 border border-amber-800 text-amber-500 flex items-center justify-center font-mono text-[11px] font-bold flex-shrink-0 mt-0.5">
                  {i + 1}
                </span>
