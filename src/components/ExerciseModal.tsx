...
export const ExerciseModal: React.FC<ExerciseModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div
        className="bg-[#0b182b] border border-sky-800/80 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl shadow-cyan-950/50 flex flex-col"
        onClick={(e) => e.stopPropagation()}
      >
        
        {/* Modal Header */}
        <div className="p-4 sm:p-5 border-b border-sky-950 bg-[#07101d] flex items-center justify-between sticky top-0 z-10">
        ...
        <div className="p-5 sm:p-6 space-y-5 flex-1">
          ...
          <div className="p-4 rounded-xl bg-[#071220] border border-sky-900/60">
          ...
          <div>
            ...
            <div className="space-y-3">
              {exercise.options.map((option, idx) => {
                ...
                let cardStyle = "bg-[#0d1f35] border-sky-950/80 hover:bg-[#122b4a] text-slate-200";
        ...
        {/* Modal Footer */}
        <div className="p-4 border-t border-sky-950 bg-[#07101d] flex items-center justify-between">
